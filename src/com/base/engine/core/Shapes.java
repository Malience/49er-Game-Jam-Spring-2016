...
public class Shapes {
	public static Mesh box(Vector3f halfSize) {
		return box(halfSize, true);
	}
	...
	public static Mesh inverseBox(Vector3f halfSize) {
		return box(halfSize, false);
	}
	...
	// public static Mesh plane(Vector3f direction, Vector2f halfSize){return
	// plane(direction, halfSize, true);}
	// public static Mesh plane(Vector3f direction, Vector2f halfSize, boolean
	// normals)
	// {
