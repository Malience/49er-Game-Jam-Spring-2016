...
public class Matrix4f {
	...
	public void setInverse(Matrix4f other) {
		...
		m[0][3] = (n[2][1] * n[1][2] * n[0][3] - n[1][1] * n[2][2] * n[0][3] - n[2][1] * n[0][2] * n[1][3]
				+ n[0][1] * n[2][2] * n[1][3] + n[1][1] * n[0][2] * n[2][3] - n[0][1] * n[1][2] * n[2][3]) * det;
		m[1][3] = (-n[2][0] * n[1][2] * n[0][3] + n[1][0] * n[2][2] * n[0][3] + n[2][0] * n[0][2] * n[1][3]
				- n[0][0] * n[2][2] * n[1][3] - n[1][0] * n[0][2] * n[2][3] + n[0][0] * n[1][2] * n[2][3]) * det;
		m[2][3] = (n[2][0] * n[1][1] * n[0][3] - n[1][0] * n[2][1] * n[0][3] - n[2][0] * n[0][1] * n[1][3]
				+ n[0][0] * n[2][1] * n[1][3] + n[1][0] * n[0][1] * n[2][3] - n[0][0] * n[1][1] * n[2][3]) * det;
	}
	...
	public float getDeterminant() {
		return m[2][0] * m[1][1] * m[0][2] + m[1][0] * m[2][1] * m[0][2] + m[2][0] * m[0][1] * m[1][2]
				- m[0][0] * m[2][1] * m[1][2] - m[1][0] * m[0][1] * m[2][2] + m[0][0] * m[1][1] * m[2][2];
	}
	...
	public Vector3f transformInverse(Vector3f r) {
		...
		return new Vector3f(out.x * m[0][0] + out.y * m[1][0] + out.z * m[2][0],

				out.x * m[0][1] + out.y * m[1][1] + out.z * m[2][1],

				out.x * m[0][2] + out.y * m[1][2] + out.z * m[2][2]);
	}

	public Vector3f transformDirection(Vector3f r) {
		return new Vector3f(r.x * m[0][0] + r.y * m[0][1] + r.z * m[0][2],
	...
	public Vector3f transformInverseDirection(Vector3f r) {
		return new Vector3f(r.x * m[0][0] + r.y * m[1][0] + r.z * m[2][0],

				r.x * m[0][1] + r.y * m[1][1] + r.z * m[2][1],

				r.x * m[0][2] + r.y * m[1][2] + r.z * m[2][2]);
	}
