...
public class RenderGenerator {
	...
	public RenderGenerator(String mesh) {
		this(mesh, "test.png");
	}

	public RenderGenerator(String mesh, String texture) {
		this(mesh, new Texture(texture));
	}
	...
	public RenderGenerator(String mesh, String texture, MaterialAttachment attach) {
		this(mesh, new Texture(texture), attach);
	}
