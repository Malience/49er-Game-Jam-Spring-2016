...
public class Mesh {
	...
	private void calcNormals(Vertex[] vertices, int[] indices) {
		...
		for (int i = 0; i < vertices.length; i++)
			vertices[i].setNormal(vertices[i].getNormal().normal());
	}
	...
	public static void loadMesh(String fileName, Vertex[] vertices, int[] indices) {

	}

	public static void loadMesh(String fileName, Vector2f[] vertices, int[] indices) {
