...
public class UIBarCircle extends UIElement implements UIRenderable {
	...
	public UIBarCircle(String texturePath, float radius) {
		this(texturePath, radius, 0);
	}
	...
	public void generate() {
		...
		// Iterations are a quarter of the circle so double it and then the 4
		// cardinal points + the center point
		...
		texCoords[0] = new Vector2f(.5f, .5f); // Because the center's texture
												// coord should always be the
												// middle
