			...
			if (uniformType.equals("sampler2D")) {
				...
				if (uniformType.equals("vec3")) {
					...
					if (uniformName.contains("[")) {
						...
						if (buffer != null)
							setUniformfbuffer(uniformName, buffer);
					} else
					...
					if (uniformName.contains("[")) {
						...
						if (buffer != null)
							setUniformibuffer(uniformName, buffer);
					} else
						setUniformi(uniformName, material.getInt(uniformName));
				...
				// renderingEngine.getActiveLight().getMVP());
				// }
				// else if(uniformName.equals("depthBiasMVP"))
				// {
				// setUniform(uniformName,
				// renderingEngine.getActiveLight().getMVP().mul(new
				// Matrix4f().biasMatrix()));
				// }
				else
