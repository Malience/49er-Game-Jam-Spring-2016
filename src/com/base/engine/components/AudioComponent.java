...
public class AudioComponent extends GameComponent implements Audible {
	...
	public AudioComponent(String soundName) {
		this(soundName, AudioEngine.findType(soundName));
	}

	public AudioComponent(String soundName, char type) {
		this(AudioEngine.findSoundLocation(soundName, type), type);
	}
