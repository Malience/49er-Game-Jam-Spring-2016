...
public class Ship extends GameObject {
	...
	public int createRoom() {
		return createRoom(0, 0, 0);
	}

	public int createRoom(float x, float y, float z) {
		return createRoom(new Vector3f(x, y, z), 0, 0, 0);
	}

	public int createRoom(int x, int y) {
		return createRoom(new Vector3f(0, 0, 0), x, y, 0);
	}
