...
public class UIBarRectBoundedIncrement extends UIBarRectBounded implements UIRenderable, Updatable
{
	...
	public UIBarRectBoundedIncrement(String texturePath, float width, float height){this(texturePath, width, height, false);}
	...
	{
		if(decrement) this.sub(delta*AMOUNT);
		else this.add(delta*AMOUNT);
		return 1;
	}
