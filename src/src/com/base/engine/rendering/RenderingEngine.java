...
public class RenderingEngine extends MappedValues
{
	...
	public RenderingEngine()
	{
		...
		//UIElement component = new UIBarRectBoundedIncrement("red.png", 400, 10, true);	
...
//		}
	...
	public void renderAll(Shader shader)
	{
		...
		{
			if(render.isActive()) render.render(shader, this);
		}
	}
	...
	public void renderAllUI()
	{
		...
		{
			if(render.isActive()) render.render(this);
		}
	}
