...
public class World 
{
	...
	public final static float[] clearColor = new float[]{0f, 1f, 1f, 0f}; //TEST MODE
	//public final static float[] clearColor = new float[]{0f, 0f, 0f, 0f}; //RELEASE MODE
	...
	public void update(float delta)
	{
		...
		{
			if(update.isActive())update.update(delta);
		}
		tick += delta;
	...
	public ArrayList<Renderable> getRenderable()
	{
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Renderable>) object.getAllComponentsOf("Renderable"));
		}
		return out;
	}
	...
	public ArrayList<UIRenderable> getUIRenderable()
	{
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends UIRenderable>) object.getAllComponentsOf("UIRenderable"));
		}
		return out;
	}
	...
	public ArrayList<Controlable> getControlable()
	{
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Controlable>) object.getAllComponentsOf("Controlable"));
		}
		return out;
	}
	...
	public ArrayList<Physical> getPhysical()
	{
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Physical>) object.getAllComponentsOf("Physical"));
		}
		return out;
	}
	...
	public ArrayList<Collidable> getCollidable()
	{
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Collidable>) object.getAllComponentsOf("Collidable"));
		}
		return out;
	}
	...
	public ArrayList<LightAttachment> getLightAttachments() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends LightAttachment>) object.getAllComponentsOf("LightAttachment"));
		}
		return out;
	}
	...
	public ArrayList<Updatable> getUpdatable() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Updatable>) object.getAllComponentsOf("Updatable"));
		}
		return out;
	}
	...
	public ArrayList<Interactable> getInteractables() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Interactable>) object.getAllComponentsOf("Interactable"));
		}
		return out;
	}
	...
	public ArrayList<Animate> getAnimate() 
	{
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Animate>) object.getAllComponentsOf("Animate"));
		}
		return out;
	}
	...
	public ArrayList<Draggable> getDraggable() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Draggable>) object.getAllComponentsOf("Draggable"));
		}
		return out;
	}
	...
	public ArrayList<DropLocation> getDropLocations() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends DropLocation>) object.getAllComponentsOf("DropLocation"));
		}
		return out;
	}
	...
	public ArrayList<Atmospherical> getAtmospherics() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Atmospherical>) object.getAllComponentsOf("Atmospherical"));
		}
		return out;
	}
	...
	public ArrayList<EnviromentalComponent> getEnviromentals() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends EnviromentalComponent>) object.getAllComponentsOf("EnviromentalComponent"));
		}
		return out;
	}
	...
	public ArrayList<BroadCollidable> getBroadCollidables() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends BroadCollidable>) object.getAllComponentsOf("BroadCollidable"));
		}
		return out;
	}
	@SuppressWarnings("unchecked")
	public ArrayList<Tickable> getTickable() {
		...
		for(GameObject object : objects)
		{
			if(object.isActive())out.addAll((Collection<? extends Tickable>) object.getAllComponentsOf("Tickable"));
		}
		return out;
	}
}
